...
var (
	...
	arcInstallation = flag.Bool("is-arc-installation", true, "If set, the CRDs are installed on an ARC managed cluster.")
)
...
func main() {
	...
	klog.Infof("ARC installation: %v", *arcInstallation)
	...
	if err := installCRDs(ctx, client, crdPath, *mode, *arcInstallation); err != nil {
